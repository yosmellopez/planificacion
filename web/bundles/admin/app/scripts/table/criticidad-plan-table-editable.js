var TableEditableCriticidadPlan = function () {

    var oTable;
    var rowDelete = null;
    var cont = 0;
    var formTitle = "¿Deseas crear una nueva criticidad de plan? Sigue los siguientes pasos:";

    //Inicializa la tabla
    var initTable = function () {
        var table = $('#criticidad-plan-table-editable');
        ...
        oTable.init({
            ...
            dataTable: {
                ...
                "ajax": {
                    "url": "criticidad-plan/listarCriticidad", // ajax source
                },
                "order": order,
                responsive: {
                    details: {}
    ...
    var btnClickModalEliminar = function () {
        ...
        Metronic.blockUI({target: '#criticidad-plan-table-editable', animate: true});

        $.ajax({
            type: "POST",
            url: "criticidad-plan/eliminarCriticidad",
            dataType: "json",
            data: {
                'criticidad_id': criticidad_id
            },
            success: function (response) {
                Metronic.unblockUI('#criticidad-plan-table-editable');
                if (response.success) {
    ...
    var btnClickModalEliminarSeleccion = function () {
        ...
        $.ajax({
            type: "POST",
            url: "criticidad-plan/eliminarCriticidades",
            dataType: "json",
    ...
    var btnClickSalvarForm = function () {
        ...
        if ($('#criticidad-form').valid()) {
            ...
            $.ajax({
                type: "POST",
                url: "criticidad-plan/salvarCriticidad",
                dataType: "json",
                contentType: "application/json;charset=utf-8",
                data: JSON.stringify({
                    'criticidad_id': criticidad_id === "" ? null : criticidad_id,
    ...
    var initAccionEditar = function () {
        $(document).on('click', "#criticidad-plan-table-editable a.edit", function (e) {
            e.preventDefault();
            resetForms();
        ...
        function editRow(criticidad_id) {
            ...
            $.ajax({
                type: "POST",
                url: "criticidad-plan/cargarDatos",
                dataType: "json",
                data: {
                    'criticidad_id': criticidad_id
                },
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        formTitle = "¿Deseas actualizar la criticidad de plan \"" + descripcion + "\" ? Sigue los siguientes pasos:";
                        $('#form-criticidad-title').html(formTitle);
    ...
    var initAccionEliminar = function () {
        $(document).on('click', "#criticidad-plan-table-editable a.delete", function (e) {
            e.preventDefault();
