(function () {
    ...
    angular
        .module('app.tareas')
        .controller('MisTareas', MisTareas);

    MisTareas.$inject = ['$rootScope', '$scope', '$timeout', 'urlPath', 'gerenciaService', 'criticidadTareaService', 'estadoTareaService'];

    function MisTareas($rootScope, $scope, $timeout, urlPath, gerenciaService, criticidadTareaService, estadoTareaService) {
        var vm = this;
        vm.urlPath = urlPath;
