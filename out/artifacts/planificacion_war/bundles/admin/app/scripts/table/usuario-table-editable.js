...
var TableEditableUsuarios = function () {
    ...
    var btnClickSalvarForm = function () {
        ...
        if ($('#usuario-form').valid() && rol_id !== "") {
            ...
            $.ajax({
                type: usuario_id === "" ? "POST" : "PUT",
                url: usuario_id === "" ? "usuario/insertarUsuario" : "usuario/guardarUsuario/" + usuario_id,
                dataType: "json",
                contentType: "application/json;charset=utf-8",
                data: JSON.stringify({
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        scopeUsuario = angular.element('#titular').scope();
                        scopeUsuario.titular = response.usuario.titular;
                        scopeUsuario.$apply();
                        //Gerencia
