(function () {
    ...
    function usuarioService($http, logger) {
        ...
        function getUsuarios() {
            ...
            return $http.get("usuario/listarUsuarios", settings)
                .then(success)
                .catch(failed);

            function success(data, status, headers, config) {
                service.usuarios = data.data.usuarios;
        ...
        function getTitulares() {
            var settings = {};
            return $http.get("usuario/listarTitulares", settings)
                .then(success)
                .catch(failed);

            function success(data, status, headers, config) {
                service.titulares = data.data.titulares;
                return service.titulares;
            }
