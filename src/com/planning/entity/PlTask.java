...
public class PlTask implements Serializable {
    ...
    @Transient
    private boolean agrupada = false;
    ...
    public void clonarDatos(PlTask tarea) {
        ...
        description = tarea.description != null && !tarea.description.isEmpty() ? tarea.description : description;
