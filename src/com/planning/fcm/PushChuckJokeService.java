...
public class PushChuckJokeService {
    ...
    public void sendChuckQuotes() {
        IcndbJoke joke = this.restTemplate.getForObject("http://api.icndb.com/jokes/random", IcndbJoke.class);
    ...
    void sendPushMessage(String joke) {
        ...
        NotificationPayload payload = NotificationPayload.builder().setBody("A new Chuck Norris joke has arrived").setTitle("Chuck Norris Joke").setTag("chuck").build();
