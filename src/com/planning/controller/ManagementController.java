...
public class ManagementController {
    ...
    public ModelAndView getManagements(@AuthenticationPrincipal Users user, ModelMap map) {
        ...
        if (user.getRol().getId() == 1) {
            ...
            if (user.isTitular() && position.isDireccion()) {
                map.put("gerencias", position.getDirecciones());
            } else {
                map.put("gerencias", new ArrayList<>());
            }
        }
